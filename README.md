...
| [visual_prompt_encoder_s.mlpackage.zip](https://github.com/john-rocky/CoreML-Models/releases/download/yolo-models-v1/visual_prompt_encoder_s.mlpackage.zip) | 20 MB | YOLOE SAVPE visual-prompt encoder (S): image + box → query | [THU-MIG/yoloe](https://github.com/THU-MIG/yoloe) | [AGPL-3.0](https://github.com/THU-MIG/yoloe/blob/main/LICENSE) | 2025 | [YOLOEDemo](sample_apps/YOLOEDemo) |
| [visual_prompt_encoder_l.mlpackage.zip](https://github.com/john-rocky/CoreML-Models/releases/download/yolo-models-v1/visual_prompt_encoder_l.mlpackage.zip) | 54 MB | YOLOE SAVPE visual-prompt encoder (L): image + box → query | [THU-MIG/yoloe](https://github.com/THU-MIG/yoloe) | [AGPL-3.0](https://github.com/THU-MIG/yoloe/blob/main/LICENSE) | 2025 | [YOLOEDemo](sample_apps/YOLOEDemo) |
